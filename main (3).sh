...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/AngIMAN/autoscript/main/"
start=$(date +%s)
secs_to_human() {
...
wget https://raw.githubusercontent.com/AngIMAN/autoscript/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
cd
...
wget -O /usr/bin/ws "https://raw.githubusercontent.com/AngIMAN/autoscript/main/Fls/ws" >/dev/null 2>&1
wget -O /usr/bin/tun.conf "https://raw.githubusercontent.com/AngIMAN/autoscript/main/Cfg/tun.conf" >/dev/null 2>&1
wget -O /etc/systemd/system/ws.service "https://raw.githubusercontent.com/AngIMAN/autoscript/main/Fls/ws.service" >/dev/null 2>&1
